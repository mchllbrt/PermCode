...
//        System.out.println(GF.gf(a));
//        
        PermutationClass univ = new PermutationClass(new Permutation("312"));
        for(Permutation q : new Permutations(univ, 3)) {
    ...
    private static void doIt(int n, int k, Permutation q) {
        ArrayList<Spectrum> specs = new ArrayList<>();
        PermutationClass all = new PermutationClass(new Permutation("312"), q);
        for(Permutation p : new Permutations(all, n)) {
            PermutationClass c = new PermutationClass(new Permutation("312"), q, p);

...
//            if (xr != UNDEFINED) {
//                System.out.println("Known problem " + problems[xr]);
//            }
    ...
    private boolean isProblem(int x, int[] f, MarkedAv321 text) {
        ...
        // System.out.println("Checking " + x + " with " + Arrays.toString(f));
        ...
        if (xd != UNDEFINED) {
            // System.out.println("Comp: " + text.navigate(f[xd], Direction.UP, type(x)));
    ...
    public HereditaryProperty avoidanceTest() {
        return new HereditaryProperty() {
            ...
            public boolean isSatisfiedBy(Permutation p) {
                return findEmbedding(new MarkedAv321(p))[0] == UNDEFINED;
            }
